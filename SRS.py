...
def showimage():
    global filename
    global img
    filename=filedialog.askopenfilename(initialdir=os.getcwd(),title="Select img file",filetype=(("JPG File","*.jpg"),
                                                                                                 ("PNG File","*.png"),
                                                                                                 ("All files","*.txt")))
...
def Save():
    ...
    if N1=="" or E1=="Select Education" or re1=="" or fathername=="" or mothername=="" or F1=="" or M1=="":
        ...
        sheet.cell(column=3, row=sheet.max_row , value=E1)
...
def Update():
    ...
    sheet.cell(column=3, row=int(reg_number), value=E1)
...
#top frames
Label(root,text="Email:umeshrajeshbhai7@gmail.com",width=10,height=3,bg="#f0687c",anchor='e').pack(side=TOP,fill=X)
...
Label(obj,text="Education:",font="arial 13",bg=framebg,fg=framefg).place(x=500,y=50)
...
Education=Combobox(obj,values=['Class 1-8','Secondary Class','Higher Seconadary Class','Under Graduate','Graduate','Post Graduate','PhD'],font="Roboto 10",width=17,state="r")
Education.place(x=630,y=50)
Education.set("Select  Education")
